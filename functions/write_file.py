...
schema_write_file = types.FunctionDeclaration(
    name="write_file",
    description="Writes to a data file given the relative path from the working directory to the file and the content to be written, constrained to the working directory.",
    parameters=types.Schema(
        ...
        properties={
            ...
            "content": types.Schema(
                type=types.Type.STRING,
                description="The contents to be written to the specifed file"
            )
        },
    ),
)
